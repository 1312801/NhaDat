...
Land.create!(TenDuAn: 'FLC GRAND HOTEL HẠ LONG', TenChuDauTu: 'Công ty Cổ phần Tập đoàn FLC', Gia:'', Phuong: ' Hồng Hà',ThanhPho: 'Hạ Long',Tinh: 'Quảng Ninh', DiaChi:'Cột số 3 - số 8, phường Hồng Hà, Hạ Long, Quảng Ninh',Dientich: '2.240.000 m²')
Land.create!(TenDuAn: 'PentStudio', TenChuDauTu: ' Công ty CP Tứ Hiệp Hồng Hà Dầu Khí', Gia:'', Phuong: ' Phú Thượng',ThanhPho: 'Hà Nội', DiaChi:'Lô B, số 699 Lạc Long Quân, phường Phú Thượng, quận Tây Hồ, Hà Nội',Dientich: ' 45-108m2')
